...
import {ArrowRight, ExternalLink, GitBranch, Lock, MessageSquare, RotateCcw, Sparkles,} from "lucide-react";
        ...
        >
            ...
            <div className="flex flex-1 flex-col gap-3 p-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    {repo.isPrivate && (
                        <span
                            className="inline-flex items-center gap-1 rounded-full border border-dashed px-2 py-0.5 text-xs text-muted-foreground">
            ...
            <div
                className="mt-auto flex items-center justify-between gap-2 border-t border-dashed border-border/70 p-4">
                {repo.htmlUrl ? (
                    <Button
                        variant="ghost"
                        size="sm"
